...
class Cell:
    ...
    def __sub__(self, other):
        if self.number > other.number:
            ...
            return 'Количество ячеек после выполнения операции становится меньше или равно 0'
    ...
    def make_order(self, num_in_raw):
        n = self.number
        print(('*' * num_in_raw + '\n') * (self.number // num_in_raw) + '*' * (self.number % num_in_raw))


my_cell = Cell(24)
my_cell.make_order(10)
my_new_cell = Cell(20)
my_add = my_cell + my_new_cell
print(my_add)
my_sub = my_cell - my_new_cell
print(my_sub)
my_mul = my_cell * my_new_cell
print(my_mul)
my_truediv = my_cell / my_new_cell
print(my_truediv)
